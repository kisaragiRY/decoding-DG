...
def main():
    ...
    for data_dir in tqdm(ParamDir().data_path_list):
        ...
        results_all = []
        for mobility in ParamData().mobility:
            dataset = Dataset(data_dir, mobility, False)
        ...
        with open(ParamDir().output_dir/data_name/(f"sm_train_with_diff_mobility.pickle"),"wb") as f:
