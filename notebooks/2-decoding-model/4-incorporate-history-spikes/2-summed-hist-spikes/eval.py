...
from param import *
from dataloader import SummedSpikesDataset
...
def main():
    ...
    for data_dir in tqdm(ParamDir().data_path_list[[0]]):
        ...
        dataset = SummedSpikesDataset(data_dir, ParamData().mode)
        with open(ParamDir().output_dir/(f"rr_summed_hist_spikes_{data_name}.pickle"),"rb") as f:
        ...
        for result in tqdm(results_all):
            ...
            with open(ParamDir().output_dir/(f"rr_summed_hist_spikes_eval_{data_name}.pickle"),"wb") as f:
