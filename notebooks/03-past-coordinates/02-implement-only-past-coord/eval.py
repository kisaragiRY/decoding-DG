...
def main():
    ...
    for data_dir in tqdm(datalist[[0,2]]):
        ...
        with open(output_dir/(f"rr_only_past_coord_{data_name}_{coord_axis}.pickle"),"rb") as f:
        ...
        for result in results_all:
            ...
            with open(output_dir/(f"rr_only_past_coord_eval_{data_name}_{coord_axis}.pickle"),"wb") as f:
